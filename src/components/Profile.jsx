function Profile() {
  return (
    <div className="profile flex flex-col basis-3/4 border-l">
      <div className="intro flex basis-[65%] justify-between items-center mx-5">
        <div className="self-intro flex flex-col basis-3/5">
          <div className="text-xl font-medium font-ubuntu my-1">
            Hello, I am
          </div>
          <div className="text-5xl font-lora font-bold mb-10">
            Nguyen Tuan Khoa
          </div>
          <div className="text-base font opacity-60 w-4/5 text-justify mb-10">
          I&apos;m a Web Developer and UI/UX Designer with a passion for creating intuitive.With a strong background in web development and a keen eye for design, I bridge the gap between beautiful interfaces and seamless user experiences. <br />
          ...
          <div className="social-icons flex gap-5 mb-5">
            <div className="fb-icon border border-black rounded p-1 cursor-pointer transition-all hover:bg-[#8A51FF]">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
                <path fill="#039be5" d="M24 5A19 19 0 1 0 24 43A19 19 0 1 0 24 5Z"></path><path fill="#fff" d="M26.572,29.036h4.917l0.772-4.995h-5.69v-2.73c0-2.075,0.678-3.915,2.619-3.915h3.119v-4.359c-0.548-0.074-1.707-0.236-3.897-0.236c-4.573,0-7.254,2.415-7.254,7.917v3.323h-4.701v4.995h4.701v13.729C22.089,42.905,23.032,43,24,43c0.875,0,1.729-0.08,2.572-0.194V29.036z"></path>
              </svg>
            </div>
            <div className="git-icon border border-black rounded p-1 cursor-pointer transition-all hover:bg-[#8A51FF]">
            ...
            <div className="link-icon border border-black rounded p-1 cursor-pointer transition-all hover:bg-[#8A51FF]">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48">
        ...
        <div className="profile-picture flex basis-2/5 items-center justify-center">
